  ...
  return (
    <section
      ...
      <div className={clsx('section-steps__content', className + '__content')}>
        <header className={clsx(className + '__header section__header')} data-js-section-header="section-steps__header">
          {
            title && (
              <h2 className={clsx(className + '__title', 'h3')}
                id={titleId}>
                {title}
              </h2>
            )}
      ...
      <div className={clsx('section-steps__picture', className + '__picture')}>
        <Image src={image} className={clsx('section-steps__image', className + '__image')} />
        {
          buttonText && (
