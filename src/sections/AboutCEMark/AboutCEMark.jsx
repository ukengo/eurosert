  ...
  return (
    ...
    >
      ...
      <div className="about-ce-mark__descroption">
        The letters ‘CE’ appear on many products traded on the extended Single
        Market in the European Economic Area (EEA). They signify that products
        sold in the EEA have been assessed to meet high safety, health, and
      ...
      <div className="about-ce-mark__content">
        <p>
          When you buy a new phone, a teddy bear, or a TV within the EEA, you
          can find the CE mark on them. CE marking also supports fair
          competition by holding all companies accountable to the same rules.
        </p>
        <p>
          By affixing the CE marking to a product, a manufacturer declares that
          the product meets all the legal requirements for CE marking and can be
          sold throughout the EEA. This also applies to products made in other
          countries that are sold in the EEA.
        </p>
        <p>
          There are two main benefits CE marking brings to businesses and
          consumers within the EEA
        </p>
      </div>
      <ul className="about-ce-mark__list">
        {aboutCeMarkList.map((item, index) => (
          <li className="about-ce-mark__item" key={index}>
            {item}
          </li>
        ))}
      </ul>
      <div className="about-ce-mark__content">
        <p>
          CE marking is a part of the EU’s harmonisation legislation, which is
          mainly managed by Directorate-General for Internal market, Industry,
          Entrepreneurship and SMEs. The CE marking for Restriction of Hazardous
          Substances is managed by Directorate-General for Environment.
        </p>
      </div>
      <h3 className="about-ce-mark__note-title">IMPORTANT NOTE:</h3>
      <p className="about-ce-mark__note-text">
        Not all products must have CE marking. It is compulsory only for most of
        the products covered by the New Approach Directives. It is forbidden to
        affix CE marking to other products.
      </p>
      <p className="about-ce-mark__note-text">
        Please note that a CE marking does not indicate that a product have been
        approved as safe by the EU or by another authority. It does not indicate
        the origin of a product either.
      </p>
    </Section>
  )
}
