...
export default () => {
  ...
  const listStepsExpert = [
    ...
    {
      title: "ISO 35001",
      description: "Biorisk management for laboratories and other related organisations",
      iconName: "iso-icon",
    },
    {
      title: "ISO 26000",
          ...
          [
            {
              ...
              description: 'We will evaluate the procedures, processes, equipment, products or materials that wish to be certified and determine whether it is possible to obtain the requested standards and what requirements they are based on',
            },
            {
              title: 'Planning and Implementation',
              description: 'Once determined what standard or certificate is feasible to obtain, a detailed planning will identify which areas and characteristics should be modified and what changes will be made to guarantee the standards included in the desired ISO regulations.',
            },
            {
              title: 'Certification Body Application',
              description: 'After making the changes, we will notify the Regulatory Authority of our intention to apply for the appropriate certificate. It will develop all the necessary documentation and carry out all procedures so that your organization receives the certificate as soon as possible.',
            },
          ]
        }
      />
